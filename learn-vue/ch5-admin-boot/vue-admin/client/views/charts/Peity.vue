    ...
    <div class="tile is-ancestor">
      <div class="tile is-parent is-6">
        <article class="tile is-child box">
          ...
          <peity :type="'donut'" :options='{ "fill": ["red", "#eeeeee"], "innerRadius": 10, "radius": 40 }'
                 :data="'1/7'"></peity>
          <peity :type="'donut'" :options='{ "fill": ["orange", "#eeeeee"], "innerRadius": 14, "radius": 36 }'
                 :data="'2/7'"></peity>
          <peity :type="'donut'" :options='{ "fill": ["yellow", "#eeeeee"], "innerRadius": 16, "radius": 32 }'
                 :data="'3/7'"></peity>
          <peity :type="'donut'" :options='{ "fill": ["green", "#eeeeee"],  "innerRadius": 18, "radius": 28 }'
                 :data="'4/7'"></peity>
          <peity :type="'donut'" :options='{ "fill": ["blue", "#eeeeee"],   "innerRadius": 20, "radius": 24 }'
                 :data="'5/7'"></peity>
          <peity :type="'donut'" :options='{ "fill": ["indigo", "#eeeeee"], "innerRadius": 18, "radius": 20 }'
                 :data="'6/7'"></peity>
          <peity :type="'donut'" :options='{ "fill": ["violet", "#eeeeee"], "innerRadius": 15, "radius": 16 }'
                 :data="'7/7'"></peity>
        </article>
      </div>
      <div class="tile is-parent is-6">
