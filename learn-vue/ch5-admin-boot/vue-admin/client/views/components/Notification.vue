      ...
      <div class="tile is-parent is-6">
        <article class="tile is-child box">
          ...
          <div class="block styles-box">
            ...
            <notification :title="'Normal'" :direction="'Down'"
            ...
            <notification :title="'Primary'" :type="'primary'" :direction="'Right'"
            ...
            <notification :title="'Info'" :type="'info'" :direction="'Right'"
            ...
            <notification :title="'Success'" :type="'success'" :direction="'Left'"
            ...
            <notification :title="'Warning'" :type="'warning'" :direction="'Left'"
            ...
            <notification :title="'Danger'" :container="'.styles-box'" :type="'danger'" :direction="'Down'"
