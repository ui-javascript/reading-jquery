    ...
    <div class="tile is-ancestor">
      <div class="tile is-parent">
        <article class="tile is-child box">
          ...
          <p class="control">
            <datepicker placeholder="Fancy Textual Format ('l, F j, Y')"
                        :config="{ dateFormat: 'l, F j, Y' }"></datepicker>
          </p>
          <p class="control">
          ...
          <p class="control">
            <datepicker placeholder="minDate: new Date('September 2, 2015')"
                        :config="{ minDate: new Date('September 2, 2015') }"></datepicker>
          </p>
          <p class="control">
      ...
      <div class="tile is-parent is-vertical">
        <article class="tile is-child box">
          ...
          <p class="control">
            ...
            <datepicker placeholder="The real input is hidden :^)"
                        :config="{ altInput: false, altFormat: 'F j, Y' }"></datepicker>
        ...
        <article class="tile is-child box">
          ...
          <p class="control">
            <datepicker
              :config="{ utc: true, defaultDate: '2016-03-01 03:30:00 -0300', enableTime: true }"></datepicker>
          </p>
          <p class="control">
    ...
    <div class="tile is-ancestor">
      <div class="tile is-parent is-vertical">
        <article class="tile is-child box">
          ...
          <p class="control">
            <datepicker placeholder="24 hour time"
                        :config="{ enableTime: true, time_24hr: true, dateFormat: 'Y-m-d H:i' }"></datepicker>
          </p>
          <p class="control">
            <datepicker placeholder="Pick date and time"
                        :config="{ enableTime: true, enableSeconds: true, dateFormat: 'Y-m-d h:i:S K' }"></datepicker>
          </p>
        </article>
        <article class="tile is-child box">
          <h1 class="title">Time Picker</h1>
          <p class="control">
            <datepicker placeholder="Pick time" :config="{ enableTime: true, enableSeconds: true, noCalendar: true }"
                        value="09:00:00"></datepicker>
          </p>
        </article>
      </div>
      <div class="tile is-parent is-vertical">
        <article class="tile is-child box">
          ...
          <p class="control">
            <datepicker placeholder="disabled from July 6-9"
                        :config="{ disable: [ { from: '2016-07-06', to: '2016-07-09' }, '2016-07-24' ], minDate: 'today' }"></datepicker>
          </p>
          <p class="control">
            <datepicker placeholder="disabled September 6-9 & August 25-31 2016"
                        :config="{ disable: [ { from : '2016-09-06', to : '2016-09-09' }, { from : '2016-08-25', to : '2016-08-31' } ], minDate: 'today', dateFormat: 'Y-m-d' }"></datepicker>
          </p>
        </article>
        <article class="tile is-child box">
    ...
    <div class="tile is-ancestor">
      <div class="tile is-parent">
        <article class="tile is-child box">
          ...
          <p class="control">
            <datepicker
              :config="{ prevArrow: '<i class=\'fa fa-angle-left\'></i>', nextArrow: '<i class=\'fa fa-angle-right\'></i>' }"></datepicker>
          </p>
        </article>
      </div>
      <div class="tile is-parent">
