    ...
    <div class="tile is-ancestor">
      <div class="tile is-parent">
        <article class="tile is-child box">
          ...
          <h2 class="subtitle">If you want to group buttons together, use the is-grouped modifier on the control
            container:</h2>
      ...
      <div class="tile is-parent">
        <article class="tile is-child box">
          ...
          <h2 class="subtitle">If you want to use buttons as addons, use the has-addons modifier on the control
            container:</h2>
