<template>
	<section>
		...
		<el-table :data="resources" highlight-current-row
			...
			<el-table-column prop="name" label="用户" width="120" sortable>
			</el-table-column>
			<el-table-column prop="ownroles" label="拥有角色" width="180" sortable>
			</el-table-column>
			...
			<el-table-column label="操作">
				<template scope="scope">
					<div v-if="testStatus(scope.row.status)">
						...
						<el-button type="default" size="small">角色分配</el-button>
						<el-button type="danger" size="small">删除</el-button>
					</div>
					<div v-else>
						<el-button type="success" size="small">开启</el-button>
						<el-button type="default" size="small">角色编辑</el-button>
						<el-button type="danger" size="small">删除</el-button>
					</div>
				</template>
			</el-table-column>
	...
	export default {
		data() {
			return {
				...
				resources: [{
					"id": 1, "name": "admin", "ownroles": "运营方、超级管理员", "description": "超级管理员", "status": 1
				}, {
					"id": 2, "name": "user01", "ownroles": "物业方", "description": "朝阳小区物业方", "status": 1
				}, {
					"id": 3, "name": "user02", "ownroles": "物业方", "description": "不知名物业方", "status": 0
				}, {
					"id": 4, "name": "user03", "ownroles": "物业方", "description": "白露小区", "status": 1
				}]
