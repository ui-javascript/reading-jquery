	...
	<section>
			...
			<el-table-column label="操作">
				<template scope="scope">
					<div v-if="testStatus(scope.row.status)">
						...
						<el-button type="default" size="small">权限分配</el-button>
		...
		<el-dialog title="编辑" v-model="editFormVisible" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
				<el-form-item label="角色号" prop="name">
		...
		<el-dialog title="新增" v-model="addFormVisible" :close-on-click-modal="false">
			<el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
				...
				<el-form-item label="描述" prop="description" width="200">
	...
	export default {
		data() {
			return {
				...
				roles: [{
					"id": 1, "name": "超级管理员", "description": "运营平台方，拥有对大多数功能的权限，但不包括对物业方信息的操作。", "status": 1
				}, {
					"id": 2, "name": "运营方", "description": "对运营平台进行基本操作", "status": 1
				}, {
					"id": 3, "name": "物业方", "description": "对物业管理进行基本操作", "status": 1
				}]
