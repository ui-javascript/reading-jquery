<template>
	<section>
		...
		<el-table :data="resources" highlight-current-row
							v-loading="listLoading"
							@selection-change="selsChange"
							style="width: 100%;">
			...
			<el-table-column prop="parent" label="父级权限" width="180" sortable>
			</el-table-column>
			<el-table-column prop="name" label="权限名" width="180" sortable>
			</el-table-column>
			<el-table-column prop="description" label="描述">
			</el-table-column>
		...
		<el-dialog title="编辑" v-model="editFormVisible" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
				<el-form-item label="权限号" prop="name">
	...
	export default {
		data() {
			return {
				...
				resources: [{
					"id": 1, "parent": "", "name": "系统管理", "description": "运营平台系统管理模块", "status": 1
				}, {
					"id": 2, "parent": "系统管理", "name": "系统参数", "description": "对系统参数进行设置", "status": 1
				}, {
					"id": 3, "parent": "系统管理", "name": "系统日志", "description": "对系统登录等活动进行记录", "status": 1
				}, {
					"id": 4, "parent": "", "name": "统计分析", "description": "物业方对订单收益等进行的统计", "status": 1
				}, {
					"id": 5, "parent": "统计分析", "name": "订单统计", "description": "物业方对订单变化趋势进行的统计", "status": 1
				}, {
					"id": 6, "parent": "统计分析", "name": "自定义统计", "description": "物业方自定义统计因子 ", "status": 0
				}]
