<template>
	<section>
		...
		<el-table :data="spaces" highlight-current-row
			...
			<el-table-column prop="name" label="车位名" width="120" sortable>
			</el-table-column>
			<el-table-column label="所属业主" width="120">
				<template scope="scope">
					{{ '张三' + scope.$index }}
				</template>
			</el-table-column>
			<el-table-column label="业主手机号" width="120">
				<template scope="scope">
			...
			<el-table-column label="操作">
				<template scope="scope">
					...
					<div v-else>
						<el-button type="danger" size="small" @click="handleStatus(scope.row, 2)">禁用</el-button>
					</div>
