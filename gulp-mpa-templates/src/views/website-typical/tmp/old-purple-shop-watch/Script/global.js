    ...
    $.ajax({
        ...
        success: function(a, d, c) {
            if (0 < a.length) {
                ...
                e += '<div class="total fr">共<b>' + f + "</b>件商品共计<strong>￥" + g.toFixed(2) + '</strong><br><a href="' + cart_wbiao_cn + '"id="payfor">去购物车结算</a></div>';
                $("#settleup").html(e);
            ...
            } else $("#settleup").html('<center style="padding-top:8px;">购物车中还没有商品，赶紧选购吧！</center>'),
            $("#cart_goods_count").text("0")
        },
        error: function() {
            $("#settleup").html("<center>对不起！加载不到你要的数据！</center>")
        }
    })
};
function top_buy_cart() {
    $("#clearing").mouseenter(function() {
        ...
        0 == $("#settleup").length && $(this).append('<div id="settleup"><center><img src="' + qdimg_wbiao_cn + 'common/4.0/loading.gif" />正在加载，请稍等...</center></div>');
        if (0 == $("#settleup").find(".cart_goods").length) {
            var a = $.cookie("CART_GOODS");
            "" == a && null == a ? $("#settleup").html('<center style="padding-top:8px;">购物车中还没有商品，赶紧选购吧！</center>') : cart_goods()
        }
    }).mouseleave(function() {
        $("#settleup").remove();
    ...
    $.ajax({
        ...
        success: function(b) {
            ...
            alert(b.message);
                ...
                0 < $("#settleup").find(".cart_goods").length && (b = $.cookie("CART_GOODS"), "" == b && null == b ? $("#settleup").html('<center style="padding-top:8px;">购物车中还没有商品，赶紧选购吧！</center>') : cart_goods())
            }
...
function set_member_info_html() {
    var a = $.cookie("_uid");
    0 < parseInt(a) ? (a = $.cookie("cps_qqcaibei_show_usermsg"), "undefined" != a && "undefined" != typeof a && "" != a && "null" != a ? $("#member_info").html(decodeURIComponent(a) + ' <a href="' + user_wbiao_cn + 'index/logout" title="退出" rel="nofollow">退出</a>') : $("#member_info").html('您好！<a href="' + user_wbiao_cn + '" title="点击进入会员中心" rel="nofollow">' + decodeURIComponent($.cookie("_uname")) + '</a>，欢迎光临万表网！<a href="' + user_wbiao_cn + 'index/logout" title="退出" rel="nofollow">退出</a>'), a = $.cookie("cps_qqcaibei_show_HeadShow"), "undefined" != a && ("undefined" != typeof a && "" != a) && ($.cookie("cps_qqcaibei_show_JifenUrl"), $("#member_info2").html('<div id="top-bar2"><div class="context">' + _selfdecodeURIComponent(a) + ' | <a href="http://cb.qq.com/my/my_jifen_source.html" target="_blank">我的彩贝积分</a></div></div>'))) : $("#member_info").html('<a href="' + user_wbiao_cn + "index/login?" + Math.random() + "\" onclick=\"_gaq.push(['_trackEvent','users','register_link','header links']);\" class=\"f12\">登录</a> <a href=\"" + user_wbiao_cn + "index/register?" + Math.random() + '" class="f12">注册<i class="red">(即赠50元)</i></a>')
}
...
function footer_links() {
    $("#footer_links").append('<a href="http://netadreg.gzaic.gov.cn/ntmm/WebSear/WebLogoPub.aspx?logo=440106106022011072001823" rel="nofollow" target="_blank"><img alt="工商网监" src="http://theme.wbiao.cn/images/gzaic.gif" /></a><a href="http://www.ccredit.cn/eca/eca_c.aspx?id=231" rel="nofollow" target="_blank"><img src="http://theme.wbiao.cn/images/eca01.jpg" alt="wangzhou weiquan biaozhun" border="0"></a><a href="http://huodong.ebrun.com/2011b2c/new/bdlist" target="_blank" rel="nofollow" title="2011消费者最喜爱的网站TOP100"><img src="http://theme.wbiao.cn/images/top100.gif" /></a>  <a href="http://www.etao.com/" target="_blank" rel="nofollow" title="一淘"><img src="http://theme.wbiao.cn/images/etao.jpg" height="35" /></a>  <a target="_blank" rel="nofollow" href="http://union.tenpay.com/cgi-bin/trust_mch/ShowTrustMchInfo.cgi?uin=1211552601&uin_type=1"><img src="http://theme.wbiao.cn/images/tenpay.jpg" border="0"></a>  <a style="display:inline-block;" kx_type="图标式" rel="nofollow" target="_blank" tabindex="-1" id="kx_verify" href="https://ss.knet.cn/verifyseal.dll?sn=e12090344010035445000000&amp;ct=df&amp;a=1&amp;pa=423879"> <img  width="108" height="35" alt="可信网站" oncontextmenu="return false;" style="border:none;" src="http://theme.wbiao.cn/images/kexin.jpg"> </a><a id="___szfw_logo___" href="https://search.szfw.org/cert/l/CX20130124002185002221" target="_blank"><img src="http://theme.wbiao.cn/images//cert.png" style="height:35px;"></a>')
}
...
function two_demension() {
    $(".c__dimension, .i__weixin").mouseenter(function() {
        $(this).after('<div class="qrcode"><img src="' + qdimg_wbiao_cn + 'common/4.0/qrcode.jpg" alt="扫描万表网二维码" /></div>')
    }).mouseleave(function() {
        $(".qrcode").remove()
    })
}
...
function morefriendlinks() {
    $("#more_fl").click(function() {
        "更多&gt;&gt;" == $(this).html() ? ($("#lnks2").css("height", "auto"), $(this).html("收起&lt;&lt;")) : ($("#lnks2").css("height", "20px"), $(this).html("更多&gt;&gt;"));
        return ! 1
    })
}
function addToCartT(a, b, d, c) {
    ...
    function(a) {
        ...
        0 != a.errors ? alert(a.message) : 1 == d ? top.location.href = cart_wbiao_cn: 2 == d ? ($("#clt_msg").html("<span class='sc'>" + a.message + "<a href='" + cart_wbiao_cn + "' class='settle'>去购物结算</a></span>"), $("#clt_msg").animate({
            top: "-58px",
            height: "74px"
        },
...
function pagination(a, b, d) {
    ...
    if (a && 1 < a.length) {
        c += '<div id="page_nav">';
        c = b != a[0] ? c + ('<a class="pre" href="javascript:void(0);" alt="' + (b - 1) + '">上一页</a>') : c + '<span class="pre">上一页</span>';
        ...
        c = b != a[a.length - 1] ? c + ('<a class="next" href="javascript:void(0);" alt="' + (b + 1) + '">下一页</a>') : c + '<span class="next">下一页</span>';
        c += "</div>"
    }
    return c
};