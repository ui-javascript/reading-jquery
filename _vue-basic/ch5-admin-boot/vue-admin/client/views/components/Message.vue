      ...
      <div class="tile is-parent is-6">
        <article class="tile is-child box">
          ...
          <div class="block styles-box">
            ...
            <message :title="'Info'" :type="'info'" :direction="'right'"
            ...
            <message :title="'Success'" :type="'success'" :direction="'left'"
            ...
            <message :title="'Warning'" :type="'warning'" :direction="'left'"
            ...
            <message :title="'Danger'" :container="'.styles-box'" :type="'danger'" :direction="'down'"
